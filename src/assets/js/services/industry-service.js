(function(){
  ...
  app.factory('IndustryService',['$http','$cookies',function($http,$cookies){
    
    $http.defaults.headers.post['X-CSRFToken'] = $cookies.csrftoken;
    var factory = {};
    factory.getSchema = function(){
      return $http.get('/api/v1/industry-schema/');
    }
    factory.get = function(params){
      ...
      return $http.get('/api/v1/industry/',{
        params: params
      });
    };
    factory.post = function(data){
      
      return $http.post('/api/v1/industry/',data);
    };
    factory.updateFile = function(id,data){
      ...
      return $http.patch('/api/v1/industry/'+id+'/',fd,{
    ...
    factory.update = function(id,data){
      ...
      if(image.length > 0 && data.image && data.image.type){
        ...
        return $http.patch('/api/v1/industry/'+id+'/',data);      
      }
    };
    factory.delete = function(id){
      
      return $http.delete('/api/v1/industry/'+id+'/');
    };
