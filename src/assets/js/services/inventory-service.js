(function(){
  ...
  app.factory('InventoryService',['$http','$cookies',function($http,$cookies){
    ...
    factory.getActiveCategories = function(params){
      return $http.get('/api/v1/inventory-categories',{
        params: params
      });
    };
    ...
    factory.getOutput = function(params){
      ...
      return $http.get('/api/v1/inventory-output',{
        params: params,
        paramSerializer: function ($params){
