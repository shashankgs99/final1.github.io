(function(){
  ...
  app.factory('CityService',['$http','$cookies',function($http,$cookies){
    
    $http.defaults.headers.post['X-CSRFToken'] = $cookies.csrftoken;
    var factory = {};
    factory.getSchema = function(){
      return $http.get('/api/v1/city-schema/');
    }
    ...
    factory.post = function(data){
      ...
      return $http.post('/api/v1/city/',data);
    };
    factory.update = function(id,data){
      ...
      return $http.patch('/api/v1/city/'+id+'/',fd,{
    ...
    factory.delete = function(id){
      ...
      return $http.delete('/api/v1/city/'+id+'/');
    };
