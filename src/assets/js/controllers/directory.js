(function(){
  ...
  app.controller('directory.mainController',['$scope','$window','$timeout','ParentCategoryService','CategoryService','DirectoryService',
  // 'hotRegisterer',
  function($scope,$window,$timeout,ParentCategoryService,CategoryService,DirectoryService,hotRegisterer){
    ...
    DirectoryService.get({category__sub_category__isempty:'True'}).then(function(data){
