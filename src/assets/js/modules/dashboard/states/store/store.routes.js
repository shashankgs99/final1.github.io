        ...
        $stateProvider
            .state('storeDashboard',{
                ...
                views: {
                    ...
                    'sideNavigation': {
                        templateUrl: 'assets/partials/dashboard/store/side-navigation.html',
                        controller: 'dashboard.controller'
                    },
                    'container': {
                ...
                resolve: { 
                    loadMyCtrl: ['$ocLazyLoad', function($ocLazyLoad) {
                             ...
                             '/assets/js/modules/stores/inventory-list/inventory-list.js',
                             ...
                             '/assets/js/modules/stores/view-MR/view-MR.js',
                             '/assets/js/services/establishment-type-service.js',
                             '/assets/js/modules/stores/material-requisition/material-requisition-list.js',
                             '/assets/js/services/store-service.js',
                             '/assets/js/services/MR-service.js',
                             '/assets/js/modules/stores/inventory-list/inventory-list.js',
                             '/assets/js/modules/stores/create-MR/create-MR.js',
                             ...
                             'assets/js/modules/stores/view-store/view-store.js'
                             ]);    
                    }]
                }
            })
            .state('storeDashboard.stores', {
                url: '/stores',
                abstract: true
            })
            .state('storeDashboard.stores.list', {
                url: '/list',
                templateUrl: '/assets/js/modules/stores/stores-list/stores-list.html',
                controller: 'Stores.ListController'
            })
            .state('storeDashboard.stores.create', {
                url: '/create',
                templateUrl: '/assets/js/modules/stores/create-store/create-store.html',
                controller: 'Stores.CreateController'
            })
            .state('storeDashboard.stores.edit', {
                url: '/edit/{storeId}',
                templateUrl: '/assets/js/modules/stores/create-store/create-store.html',
                controller: 'Stores.CreateController'
            })
            .state('storeDashboard.stores.view', {
                url: '/view/{storeId}',
                templateUrl: '/assets/js/modules/stores/view-store/view-store.html',
                controller: 'Stores.ViewController'
            })
            .state('storeDashboard.inventory', {
                url: '/inventory',
                abstract: true
            })
            .state('storeDashboard.inventory.list', {
                url: '/list',
                templateUrl: '/assets/js/modules/stores/inventory-list/inventory-list.html',
                controller:'OperationalInventoryController',
                params:{
                    inventoryId : null
                }
            })
            .state('storeDashboard.materialRequisition', {
                url: '/material-requisition',
                abstract: true
            })
            .state('storeDashboard.materialRequisition.list', {
                url: '/list',
                templateUrl: '/assets/js/modules/stores/material-requisition/material-requisition-list.html',
                controller: 'layout.standard.MRListController'
            })
            .state('storeDashboard.materialRequisition.create', {
                url: '/create',
                templateUrl: '/assets/js/modules/stores/create-MR/create-MR.html',
                controller: 'layout.standard.MRController'
            }).state('storeDashboard.materialRequisition.view', {
                url: '/view/{MRId}',
                templateUrl: '/assets/js/modules/stores/view-MR/view-MR.html',
                controller: 'MR.ViewController'
            }).state('storeDashboard.materialRequisition.edit', {
                url: '/edit/{MRId}',
                templateUrl: '/assets/js/modules/stores/create-MR/create-MR.html',
                controller: 'MR.ViewController'
            }).state('storeDashboard.team', {
                url: '/team',
                templateUrl: 'assets/partials/dashboard/supplier/team.html',
                controller: 'dashboard.supplier.team'
            }).state('storeDashboard.Messages',{
                url: '/messages',
